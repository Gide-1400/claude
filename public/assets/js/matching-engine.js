...
class MatchingEngine {
    ...
    // ========================================
    // تحميل المدن (لم يعد مستخدماً - GeoNames API بدلاً منه)
    // ========================================
    async loadCitiesFromDB() {
        try {
            // لم يعد نستخدم قاعدة البيانات للمدن
            // GeoNames API يوفر 11 مليون مكان
            console.log('ℹ️ استخدام GeoNames API للمدن (لا حاجة لتحميل من قاعدة البيانات)');
            this.cities = [];
        } catch (error) {
