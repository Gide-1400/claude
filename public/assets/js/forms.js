...
async function handleTripFormSubmit(e) {
    ...
    try {
        ...
        const tripData = {
            ...
            price_per_kg: formData.get('pricePerKg') ? parseFloat(formData.get('pricePerKg')) : null,
        ...
        const errorMessage = currentLang === 'ar'
            ? 'خطأ في إضافة الرحلة: ' + (error.message || 'حدث خطأ غير متوقع')
            : 'Error adding trip: ' + (error.message || 'An unexpected error occurred');
